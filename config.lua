...
Config.Zones = {
	...
	Garages = {
		...
		{ -- Cayo 1 
			GaragePos  = vector3(5115.754, -4639.539, 0.405633),
			SpawnPoint = vector4(5112.619, -4643.004, -0.3997525, 175.2195),
			StorePos   = vector3(5121.188, -4646.052, -0.3998089),
			StoreTP    = vector4(5120.499, -4629.774, 0.442894, 87.36478)
		},
		{ -- Cayo 2 
			GaragePos  = vector3(4930.296, -5145.679, 1.456187),
			SpawnPoint = vector4(4928.206, -5141.976, -0.3998386, 84.95639),
			StorePos   = vector3(4939.149, -5154.585, -0.3997751),
			StoreTP    = vector4(4950.367, -5150.888, 2.443466, 322.4038)
		},
	},
...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 16899},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 16899},
	{model = 'suntrap', label = 'Suntrap', price = 25160},
	{model = 'jetmax', label = 'Jetmax', price = 299000},
	{model = 'tropic2', label = 'Tropic', price = 22000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 125000},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 125000},
	{model = 'speeder', label = 'Speeder', price = 325000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 196621},
	{model = 'toro', label = 'Toro', price = 1750000},
	{model = 'submersible', label = 'Submersible', price = 750000},
	{model = 'marquis', label = 'Marquis', price = 413990},
	{model = 'longfin', label = 'Longfin', price = 1593750},
}
